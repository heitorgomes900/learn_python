...
def get_string(message, name="string", default=None, minimum_length=0, maximum_lenght=80):
    ...
    while True:
        try:
            ...
            if not (minimum_length <= len(line) <= maximum_lenght):
                raise ValueError("{0} must have at least {1} and at most {2} characters".format(name, minimum_length, maximum_lenght))
            return line
